...
# video = cv2.VideoCapture('456.mp4')
video = cv2.VideoCapture('Pedestrians Compilation_Trim2.mp4')
...
# create car classifier. classifier identifies the object: person, car, etc.(object dection approch)
...
# Read the one frame in the video. video.read() returns a tuple
    ...
    cv2.imshow('mini_project_1', frame)
